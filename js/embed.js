...
(function(e, t, n) {
    ...
    function() {
        ...
        H.SmiliesTooltip.prototype = {
            ...
            reset: function(e) {
                ...
                function(t, r) {
                    ...
                    var i = 0 === e.indexOf("\u5fae\u535a") ? "http://img.t.sinajs.cn/t35/style/images/common/face/ext/normal/" + r.replace("_org", "_thumb") : b + "/images/smilies/" + r;
                        if (document.location.protocol == 'https:') {
        ...
        J.post = function(e, t) {
            ...
            }).join("") + "</ol>": "") + "<p>" + (u.length >= t.max_depth && (!t.show_context || t.max_depth > 1) && e.parent_id && ot[e.parent_id] ? '<a class="ds-comment-context" data-post-id="' + e.post_id + '" data-parent-id="' + e.parent_id + '">' + k.reply_to + p(K(ot[e.parent_id].data).name) + ": </a>": "") + e.message.replace(/http:\/\/static\.duoshuo\.com\//g,"https://static.duoshuo.com/").replace(/http:\/\/img\.t\.sinajs\.cn\//g,"https://img.t.sinajs.cn/") + '</p><div class="ds-comment-footer ds-comment-actions' + (e.vote > 0 ? " ds-post-liked": "") + '">' + o + "</div></div></div>" + (t.max_depth > 1 && (e.childrenArray || e.children) && e.source != "weibo" && e.source != "qqt" ? '<ul class="ds-children">' + i.map(e.childrenArray || e.children,
            function(e) {
